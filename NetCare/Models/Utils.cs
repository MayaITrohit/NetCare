...
namespace NetCare.Models
{
    public class Utils
    {
        // AppointMentDairy Table Deleted//
        //public static bool InitialiseDiary() {
        //    // init connection to database
        //    TechnicianEntities context = new TechnicianEntities();
        //    try
        //    { 
        //        for(int i= 0; i<30; i++){
        ...
        //            context.AppointmentDiaries.Add(item);
        //            context.SaveChanges();
        //    }
        //    }
        //    catch (Exception)
        ...
        //    return context.AppointmentDiaries.Count() > 0;        
        //}
